...
\``;
  ...
  return (
    <section
      className={`contact-container ${theme === "dark" ? "dark-section" : ""}`}
      id="contact"
      ref={ref}
    >
      <div
      ...
      <div className="contact-details">
        <div
          className={`highlight-container ${inView ? "show" : ""}`}
          ref={refAnimation}
        >
          <Highlight code={codeSnippet} language="tsx" theme={themes.nightOwl}>
            {({ className, style, tokens, getLineProps, getTokenProps }) => (
              <pre
                className={`${className} pre-content`}
                style={{
                  ...style,
                  whiteSpace: "pre-wrap",
                  wordWrap: "break-word",
        ...
        <form
          ...
          className={`hide-form ${inView ? "show" : ""}`}
          ref={refAnimation}
        >
          <FormInput
            form="input"
